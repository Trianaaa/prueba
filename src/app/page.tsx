      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <div className="text-center sm:text-left max-w-xl">
          ...
          <p className="text-base text-gray-700 dark:text-gray-300">
            Esta aplicación permite consultar, agregar y eliminar usuarios
            usando una API externa. Se muestran únicamente los usuarios activos
            y se brinda una interfaz amigable para gestionar sus datos.
            Desarrollada con NextJS + React, TailwindCSS y desplegada en Vercel
